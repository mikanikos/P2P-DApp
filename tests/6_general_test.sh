...
then
    ...
    then
        declare -A files
        files[0,1,0,0]="A.out"
        files[0,1,0,1]="04985e745c3d548ace56579a045c19de5545b7de6071aa2274d22e7833214064"
    fi
    ...
    echo "Qua6"
    ./client/client -UIPort=${UIPorts[$thirdSender]} -msg="$messages[$thirdSender,$messagesSendThird]}"
    sleep 3
    if [[ $TestPrivateMessages = true ]]
    then
        echo "Qua7"
