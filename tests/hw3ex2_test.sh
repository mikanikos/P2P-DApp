...
./Peerster -name=a -peers="$bAddr"        -UIPort=$aUIPort -gossipAddr=$aAddr -rtimer=5 -antiEntropy=5 -hw3ex2=true -N=4 -hopLimit=5 -stubbornTimeout=3 > "./tests/out/A.out" &
./Peerster -name=b -peers="$aAddr,$cAddr" -UIPort=$bUIPort -gossipAddr=$bAddr -rtimer=5 -antiEntropy=5 -hw3ex2=true -N=4 -hopLimit=5 -stubbornTimeout=3 > "./tests/out/B.out" &
./Peerster -name=c -peers="$bAddr,$dAddr" -UIPort=$cUIPort -gossipAddr=$cAddr -rtimer=5 -antiEntropy=5 -hw3ex2=true -N=4 -hopLimit=5 -stubbornTimeout=3 > "./tests/out/C.out" &
./Peerster -name=d -peers="$cAddr"        -UIPort=$dUIPort -gossipAddr=$dAddr -rtimer=5 -antiEntropy=5 -hw3ex2=true -N=4 -hopLimit=5 -stubbornTimeout=3 > "./tests/out/D.out" &
